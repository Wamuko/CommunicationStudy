...
public class Router {
     ...
     */
    public static final String CONTROLLER_PACKAGE_NAME = "jikkenD";
    ...
    /**
     * コントローラの探索。{@link jikkenD.Router.CONTROLLER_PACKAGE_NAME}
     * で指定されたパッケージのクラスで、{@link RequestMapping} アノテーションが付いたクラスを探し、リクエストパスと紐付ける。
     *
     * @return
     */
